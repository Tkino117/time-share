...
//         new responses.UnauthorizedResponse('Unauthorized').send(res);
//     }
//     else if (error instanceof errors.FollowPermissionError) {
//         new responses.ErrorResponse('Follow permission error').send(res);
//     }
//     else if (error instanceof errors.FollowSelfError) {
//         new responses.ErrorResponse('Follow self error').send(res);
//     }
//     else {
//         console.error(error);
//         new responses.ServerErrorResponse('Internal server error').send(res);
